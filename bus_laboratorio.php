...
<head>
    <title>Busqueda Laboratorios</title>
    <link rel="short icon" href="img/laboratorio.png" />
    <link rel="stylesheet" href="CSS/bus_laboratorio.css" />
</head <body>
...
<center>
    <section>
        ...
        <div class="busq">
            <label for="caja_busqueda">Buscar Laboratorios</label>
            <input type="text" name="caja_busqueda" id="caja_busqueda" placeholder="Ingrese codigo del laboratorio">
            <div id="datos">
    ...
    <script src="Buscar/con_laboratorio.js" type="text/javascript"></script>
</center>
</body>
